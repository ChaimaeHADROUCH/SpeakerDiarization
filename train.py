...
def train():
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor="val_der",
        dirpath="checkpoints_CNN_single/",
    ...
    logger = TensorBoardLogger("checkpoints_CNN_single/training_logs", name=None, version='logs')
    ...
    checkpoint = torch.load('/home/ubuntu/Multichannel_dia/experiment4_v1/experiment4/checkpoints_CNN_single/epoch=129-val_der=0.215622.ckpt')
