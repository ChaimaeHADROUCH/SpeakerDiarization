...
def train():
    ...
    logger = TensorBoardLogger("checkpoints_CNN_ILD/training_logs", name=None, version='logs')
    ...
    checkpoint = torch.load('/home/ubuntu/Multichannel_dia/experiment5/checkpoints_CNN_ILD/epoch=104-val_der=0.203880.ckpt')
