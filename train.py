...
def train():
    ...
    logger = TensorBoardLogger("checkpoints_exp5/training_logs", name=None, version='logs')
    trainer = pl.Trainer(
        gpus=args.gpus,
    ...
    checkpoint = torch.load('/gpfswork/rech/cjx/uaf42iq/multichannel-dia/exp5_v4/Exp5/StereoNet46/checkpoints_exp5/epoch=111-val_der=0.213547.ckpt')
    
    model = StereoNet.from_config(config, writer, torch.Tensor([0.5600000023841858]))
